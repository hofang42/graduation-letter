      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-12">
        ...
        >
          ...
          <h2 className="font-[family-name:var(--font-playfair)] text-3xl md:text-5xl font-bold mb-4">
            <span className="gradient-text-gold">{t('Mọi Thứ Bạn Cần Biết', 'Everything You Need To Know')}</span>
          </h2>
            ...
            {infoItems.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="glass-card rounded-xl p-5 transition-all duration-300 hover:border-white/10"
